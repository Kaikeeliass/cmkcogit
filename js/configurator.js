...
const ConfiguratorApp = (() => {
    ...
    return `
      <div class="cfg-step" data-step="4">
        ...
        <div class="cfg-form">
          ...
          <a href="#" class="cfg-advanced-link" id="cfg-whatsapp-direct" style="display: flex; align-items: center; justify-content: center; gap: 8px; color: #25D366;">
  ...
  function submitConfiguration() {
    ...
    trackEvent('configurator_submit', `services:${state.selectedServices.length},addons:${state.selectedAddons.length}`);

    // Show success
    containerEl.innerHTML = `
      <div class="cfg-success">
        <div class="cfg-success-icon">
        ...
        <p>Recebemos sua configuração. Em breve entraremos em contato para refinar o escopo e apresentar a proposta final.</p>
        <button class="btn btn-secondary-dark" type="button" onclick="ConfiguratorApp.reset()">Criar nova configuração</button>
      </div>
    `;
  }
